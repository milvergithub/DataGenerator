<div class="control-group">
    <select class="form-control input-sm" name="algoritmos" id="algoritmos">
        ...
        <option value="nombrecompleto">Generador de nombre completo</option>
        <option value="nombres">Generador de nombres</option>
        <option value="apellidos">Generador de apellidos</option>
    </select>
</div>
<div class="control-group">
